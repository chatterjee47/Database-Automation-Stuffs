...
public class multiplesql {
	...
	public static void main(String[] args) throws SQLException, ClassNotFoundException {
		...
		String sqlquery = "select * from  [Lookup].[ActivityType];select * from  [Lookup].[ActivityTaskSource]";
		...
		ResultSet result  = st.executeQuery(sqlquery);
			...
			if (result.next()) {
		      ...
		      //    String ActivityTaskSourceId = result.getString("ActivityTaskSourceId");
		          
		          
		          // print them on the console
		          System.out.println("Name :" + Name);
		          System.out.println("ActivityTypeID: " + ActivityTypeID);
		      //    System.out.println("ActivityTaskSourceId: " + ActivityTaskSourceId);
		        }
		        result.close();
		}		
	}
